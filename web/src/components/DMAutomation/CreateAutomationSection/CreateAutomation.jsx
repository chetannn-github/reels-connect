            ...
            <CardContent className="space-y-6">
              ...
              <Tabs value={automationType} onValueChange={(value) => setAutomationType(value)}>
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="text" className="flex items-center gap-2 text-xs md:text-sm">
                    <MessageSquare className="w-4 h-4" /> Text Messages
                  </TabsTrigger>
                  <TabsTrigger value="card" className="flex items-center gap-2 text-xs md:text-sm">
